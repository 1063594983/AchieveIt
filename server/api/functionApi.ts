...
import { FunctionResult, ResultCommon } from "achieve-it-contract";
...
// /function
// 获取项目功能
router.get("/:project_id", (req, res: Response<FunctionResult | ResultCommon>) => {
...
// 增加功能
router.post("/addFunction", (req, res: Response<FunctionResult | ResultCommon>) => {
...
// 设置功能上下级关系
router.post("/setFunctionRelation", (req, res: Response<FunctionResult | ResultCommon>) => {
